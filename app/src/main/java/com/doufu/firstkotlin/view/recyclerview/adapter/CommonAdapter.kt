package com.doufu.firstkotlin.view.recyclerview.adapter

import android.content.Context
import android.support.v7.widget.RecyclerView
import android.view.LayoutInflater
import android.view.ViewGroup
import com.doufu.firstkotlin.view.recyclerview.MultipleType
import com.doufu.firstkotlin.view.recyclerview.OnItemClickListener
import com.doufu.firstkotlin.view.recyclerview.OnItemLongClickListener
...
abstract class CommonAdapter <T>(var  mContext:Context,var mData:ArrayList<T>,
    ...
    constructor(context: Context,date: ArrayList<T>,typeSupport:MultipleType<T>):this(context,date,-1){
...
//        "!!"加在变量名后，如果对象为null，那么系统一定会报异常！
    ...
    abstract fun bindData(holder: ViewHolder, date:T, position: Int)
